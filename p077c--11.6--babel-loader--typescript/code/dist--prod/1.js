...
/* harmony import */ var _check_f01_handling_typescript___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13);
...
const p1 = new Promise((rs, rj) => {
  __webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(__webpack_require__, 15)).then(_ref => {
    let {
      default: content
    } = _ref;
...
const p2 = new Promise(async (rs, rj) => {
  ...
  try {
    const {
      default: content
    } = await __webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(__webpack_require__, 15));
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _class_student__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
